    ...
    <main className="min-h-screen bg-[#FAFAFC] text-[#111111]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-6 pt-20 pb-16">
          ...
          {/* Title */}
          <h1 className="max-w-5xl text-5xl font-semibold leading-[0.92] tracking-[-0.05em] text-[#111111] md:text-7xl xl:text-8xl">
            {title}
          </h1>
      ...
      <section className="mx-auto max-w-7xl px-6">
        ...
        <div className="overflow-hidden rounded-[36px] border border-black/5 bg-white shadow-[0_10px_60px_rgba(0,0,0,0.06)]">
