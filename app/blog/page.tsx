    ...
    return (
        <main className="min-h-screen bg-[#FAFAFC] text-[#111111] selection:bg-black selection:text-white">                {/* HERO */}
            <section className="relative overflow-hidden">
                ...
                <div className="relative mx-auto max-w-7xl px-5 py-24 md:px-6 md:py-36">
                    ...
                    <div className="max-w-5xl">
                        ...
                        <h1 className="text-4xl font-semibold leading-[1] tracking-[-0.06em] text-[#111111] sm:text-5xl md:text-7xl xl:text-[110px]">
                        ...
                        <div className="mt-12 flex flex-wrap gap-4">
                            ...
                            <a href="#articles" className="rounded-2xl bg-black px-8 py-4 text-sm font-semibold text-white shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
                                Explore Articles
                            </a>
            ...
            {/* BLOG GRID */}
            <section id="articles" className="mx-auto max-w-7xl px-6 pb-28">

                <div className="mb-14">

                    <h2 className="text-3xl font-semibold tracking-[-0.05em] text-[#111111] sm:text-4xl md:text-5xl">                        Latest Articles
                    </h2>
