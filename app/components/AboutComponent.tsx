    ...
    >
      ...
      <div>
        ...
        <p className="text-white/90 text-base md:text-lg leading-relaxed font-medium">
          We’re more than a digital agency — we’re growth architects. We design
          branding systems, websites, apps, SEO strategies, and software solutions
          that scale businesses globally with precision and performance.
        </p>
      </div>
